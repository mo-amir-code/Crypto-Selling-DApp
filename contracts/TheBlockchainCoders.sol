...
contract TheBlockchainCoder{   
       ...
       function transfer(address _to, uint256 _value) public returns (bool success) {
        require(balanceOf[msg.sender] >= _value, "Insufficient value");
        inc();
       ...
       function transferFrom(address _from, address _to, uint256 _value) public returns (bool success){
        require(_value <= balanceOf[_from], "Insuffiecient amount");
        require(_value <= allowance[_from][msg.sender], "Insuffiecient allowance amount");
